...
**Synthetic database for development & testing** — GenDB creates a shadow schema inside your PostgreSQL database populated with LLM-analyzed synthetic data, so developers can work against realistic data without production PII.
